...
import myPokemonIconGrey from '../assets/mypokemon.svg'
import pokemonListIconGrey from '../assets/pokemonlist.svg'

const MAX_WIDTH = 480;

export const PokemonListIcon = () => <div>
  <img src={pokemonListIconGrey} alt="" style={{maxWidth: "50px", margin: "-10px -10px"}}/>
</div>

export const MyPokemonIcon = () => <div>
  <img src={myPokemonIconGrey} alt="" style={{maxWidth: "50px", margin: "-10px -10px"}}/>
</div>
